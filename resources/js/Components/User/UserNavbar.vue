...
<Button  id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="text-gray-700 text-sm px-5 py-2.5 text-center inline-flex items-center  " type="button">Dropdown divider <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
