...
<div class="absolute flex grid lg:grid-cols-12 mr-0 z-30 gap-4  p-cad  ">
<div class="col-span-1 "></div>

<div class=" col-span-5 rounded rounded-lg shadow-md right-0 green-bg text-white" >
...
<p class="text-lg py-1">
 ...
 <p class="text-sm pb-1 px-12"><span>We Let You Choose From A List Of Available Hotels. You Can Even Pick The Room That You Would Like To Stay In.</span>
</p>
</div>
<div class=" px-12">
<p class="text-lg py-1">
  <img src="/img/g-card.png" class="inline-flex"/> <span class="px-3">$50 Visa gift card</span> </p>
 <p class="text-sm pb-1 px-12"><span>Book Your Trip With Us And Get A $50 Visa Gift Card To Use While On Your Trip Or Back At Home.</span>
</p>
</div>
<div class=" px-12">
<p class="text-lg py-1">
  <img src="/img/e-car.png" class="inline-flex"/> <span class="px-3">Hotel Accommodation</span> </p>
 <p class="text-sm pb-1 px-12"><span>One Of Our Ride Sharing Partners Will Pick You Up From Your Hotel And Drop You Off At The Presentation.</span>
</p>
</div>
<div class=" px-12">
<p class="text-lg py-1">
  <img src="/img/o-support.png" class="inline-flex"/> <span class="px-3">Hotel Accommodation</span> </p>
 <p class="text-sm pb-1 px-12"><span>Available 24/7. Contact Us Day Or Night And Speak With A Real Human In The United States.</span>
</p>
</div>
...
<div class="col-span-5   rounded  btn-red shadow-md ml-0 text-white pb-10">
<h1 class="p-6 mx-auto flex justify-center text-lg">
    How it Works
</h1>
<hr class="h-px my-2 bg-gray-200 border-0 ">
...
<p class="text-lg py-1">
 ...
 <p class="text-sm pb-1 px-12"><span>Enter your preferred check-in and check-out date and pick your hotel choice from the list of hotels available.</span>
</p>
</div>
<div class=" px-12">
<p class="text-lg py-1">
  <img src="/img/2.png" class="inline-flex"/> <span class="px-1">Choose a Room & Confirm Your Reservation</span> </p>
 <p class="text-sm pb-1 px-12"><span>Select the list of available rooms in your selected hotel and confirm reservation of the room of your choice</span>
</p>
</div>
<div class=" px-12">
<p class="text-lg py-1">
  <img src="/img/3.png" class="inline-flex"/> <span class="px-1">Travel to Las Vegas & Check-In at the Front Desk</span> </p>
 <p class="text-sm pb-1 px-12"><span>Travel to the location of your booked hotel and check-in at the front desk for get access to the room.</span>
</p>
</div>
<div class=" px-12">
<p class="text-lg py-1">
  <img src="/img/4.png" class="inline-flex"/> <span class="px-1">Collect Your $50 Visa Gift Card</span> </p>
 <p class="text-sm pb-1 px-12"><span>Ensure you are present to the 90 minute presentation organized by the Travel Agency and redeem your $50 Visa gift card</span>
</p>
</div>
<div class=" px-12">
<p class="text-lg py-1">
  <img src="/img/5.png" class="inline-flex"/> <span class="px-1">Enjoy the Rest of Your Trip</span> </p>
 <p class="text-sm pb-1 px-12"><span>Enjoy your wonderful Las Vegas trip as we ensure you have a wonderful time.</span>
</p>
</div>
...
<section class="bg-white mx-20 my-20 py-16">
<div class=" ">
