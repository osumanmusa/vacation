            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container mx-auto px-6 py-8">
                    ...
                    <div class="grid lg:grid-cols-3 gap-8">
                        <div class="first-grid-card h-32 border rounded-xl">
                            <div class="flex p-8 text-white ">
                                <div class="px-4 first-circle-icon">
                                    <img :src="'/img/dashboard/t.png'"/>
                                </div>
                                <div class="pl-4  font-right">
                                    <p class="py-1 inline-flex">
                                        New Registrations</p>
                                    <p class="pb-4">
                                    102 </p>
                                </div>
                        ...
                        <div class="second-grid-card h-32 border rounded-xl">
                            <div class="flex p-8 text-white ">
                                <div class="px-4 second-circle-icon">
                                    <img :src="'/img/dashboard/b.png'"/>
                                </div>
                                <div class="pl-4  font-right">
                                    <p class="py-1 inline-flex">
                                        New Bookings</p>
                        ...
                        <div class="third-grid-card h-32 border rounded-xl">
                            <div class="flex p-8 text-white ">
                                <div class="px-4 third-circle-icon">
                                    <img :src="'/img/dashboard/t.png'"/>
                                </div>
                                <div class="pl-4  font-right">
                                    <p class="py-1 inline-flex">
...
<div class="Relative inline-block my-4 mt-8">
    <p class="text-xl font-bold">New Bookings</p>
        ...
        <tbody>
            ...
            <tr class="space-x-3 w-full lg:hidden">
                <td scope="row" class="px-4 py-4 grid col-1 gap-2 ">
                    <span>Hotel Contact: Rajeshrayo@gmail.com</span>
                    <span>Room: Single</span>
                    <span>Arrival: 08/21/15</span>
                    <span>Departure: 12/21/15</span>
                </td>
